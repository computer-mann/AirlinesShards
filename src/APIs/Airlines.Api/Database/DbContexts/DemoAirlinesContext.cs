...
public partial class DemoAirlinesContext : DbContext
{
    public DemoAirlinesContext()
    {
    }

    public DemoAirlinesContext(DbContextOptions<DemoAirlinesContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Base_Models.Route> Routes { get; set; }
