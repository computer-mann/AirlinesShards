...
namespace Infrastructure.Migrations.Traveller
{
    ...
    [Migration("20240302142817_TempMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirlinesApi.AircraftsData", b =>
                {
            ...
            modelBuilder.Entity("AirlinesApi.AirportsData", b =>
                {
            ...
            modelBuilder.Entity("AirlinesApi.BoardingPass", b =>
                {
            ...
            modelBuilder.Entity("AirlinesApi.Booking", b =>
                {
            ...
            modelBuilder.Entity("AirlinesApi.Seat", b =>
                {
                    b.Property<string>("AircraftCode")
                        .HasMaxLength(3)
                        .HasColumnType("character(3)")
            ...
            modelBuilder.Entity("AirlinesApi.SeatClass", b =>
                {
            ...
            modelBuilder.Entity("AirlinesApi.Ticket", b =>
                {
                    b.Property<string>("TicketNo")
                        .HasMaxLength(13)
                        .HasColumnType("character(13)")
            ...
            modelBuilder.Entity("AirlinesApi.TicketFlight", b =>
                {
                    b.Property<string>("TicketNo")
                        .HasMaxLength(13)
                        .HasColumnType("character(13)")
            ...
            modelBuilder.Entity("AirlinesApi.Traveller", b =>
                {
            ...
            modelBuilder.Entity("AirlinesApi.VwAircraft", b =>
                {
                    b.Property<string>("AircraftCode")
                        .HasMaxLength(3)
                        .HasColumnType("character(3)")
            ...
            modelBuilder.Entity("AirlinesApi.VwAirpot", b =>
                {
                    b.Property<string>("AirportCode")
                        .HasMaxLength(3)
                        .HasColumnType("character(3)")
            ...
            modelBuilder.Entity("AirlinesApi.VwFlight", b =>
                {
                    b.Property<DateTime?>("ActualArrival")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("actual_arrival")
            ...
            modelBuilder.Entity("AirlinesApi.VwRoute", b =>
                {
                    b.Property<string>("AircraftCode")
                        .HasMaxLength(3)
                        .HasColumnType("character(3)")
            ...
            modelBuilder.Entity("AirlinesApi.BoardingPass", b =>
                {
                    b.HasOne("AirlinesApi.TicketFlight", "TicketFlight")
                        .WithMany()
            ...
            modelBuilder.Entity("AirlinesApi.Flight", b =>
                {
                    b.HasOne("AirlinesApi.AircraftsData", "AircraftCodeNavigation")
                        .WithMany("Flights")
                        .HasForeignKey("AircraftCode")
                        .IsRequired()
                        .HasConstraintName("flights_aircraft_code_fkey");

                    b.HasOne("AirlinesApi.AirportsData", "ArrivalAirportNavigation")
                        .WithMany()
                        .HasForeignKey("ArrivalAirportNavigationAirportCode");

                    b.HasOne("AirlinesApi.AirportsData", "DepartureAirportNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("AirlinesApi.Ticket", b =>
                {
                    b.HasOne("AirlinesApi.Booking", "BookRefNavigation")
                        .WithMany("Tickets")
                        .HasForeignKey("BookRef")
                        .IsRequired()
                        .HasConstraintName("tickets_book_ref_fkey");

                    b.HasOne("AirlinesApi.Traveller", "Passenger")
                        .WithMany("Tickets")
