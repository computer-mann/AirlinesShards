        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArrivalAirportNavigationAirportCode = table.Column<string>(type: "character(3)", nullable: true),
                    DepartureAirportNavigationAirportCode = table.Column<string>(type: "character(3)", nullable: true)
                },
                constraints: table =>
                {
