...
{
    /// <inheritdoc />
    public partial class CreatingtheTrouper : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "varchar(35)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_troupers_UserId",
                        column: x => x.UserId,
                        principalSchema: "bookings",
                        principalTable: "troupers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_troupers_UserId",
                        column: x => x.UserId,
                        principalSchema: "bookings",
                        principalTable: "troupers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_troupers_UserId",
                        column: x => x.UserId,
                        principalSchema: "bookings",
                        principalTable: "troupers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserTokens_troupers_UserId",
                        column: x => x.UserId,
                        principalSchema: "bookings",
                        principalTable: "troupers",
                        principalColumn: "Id",
